...
assert_contains "$ROOT_DIR/ios/VoiceCalendarAssistant/VoiceCalendarAssistant/VoiceAssistantViewModel.swift" "BackendPreflightService.warmBackend" "Action Button cold start preflights backend"
assert_contains "$ROOT_DIR/ios/VoiceCalendarAssistant/VoiceCalendarAssistant/VoiceAssistantViewModel.swift" "RealtimeClient.connect.coldStartWarmup" "Action Button cold start warms Realtime before recording"
